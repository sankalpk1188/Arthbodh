...
class HomepageController extends Controller
{
        ...
        if($request->isMethod('post')){
            ...
            if($request->hasFile('image')) {
                ...
                if ($image_tmp->isValid()) {
                    ...
                    $path = 'assets/images/banner/' . $filename;
        ...
        if($request->isMethod('post')){
            ...
            if($request->hasFile('image')) {
                ...
                if ($image_tmp->isValid()) {
                    ...
                    $newsviews_path = 'assets/images/about/'.$filename;
        ...
        if($request->isMethod('post')){
            ...
            if ($request->hasFile('image')) {
                ...
                if ($image_tmp->isValid()) {
                    $extension = $image_tmp->getClientOriginalName();
                    $filename = strtotime("now") . '.' . $extension;
                    $collaborate_path = 'assets/images/about/' . $filename;
    ...
    // add new whyarthbodh
    public function addWhyarthbodh(Request $request){
        if($request->isMethod('post')){
            $data = $request->all();
            //dd($data);
            $whyarthbodh = new Whyarthbodh;
            $whyarthbodh->title = $data['title'];

            if($request->hasFile('image')) {
                $image_tmp = $request->image;
                if ($image_tmp->isValid()) {
                    $filename = strtotime("now").'-'. $image_tmp->getClientOriginalName();
                    $newsviews_path = 'assets/images/whyarthbodh/'.$filename;
                    Image::make($image_tmp)->save($newsviews_path);
                    $whyarthbodh->image = $filename;
                }
            }
            $whyarthbodh->save();
            return redirect('admin/view-whyarthbodh')->with('flash_message_success','New record added successfully');
        }
        return view('admin.whyarthbodh.add-whyarthbodh');
    }
    
    // edit specific whyarthbodh
    public function editWhyarthbodh(Request $request, $id){
        if($request->isMethod('post')){
            $data = $request->all();
            ...
            if ($request->hasFile('image')) {
                ...
                if ($image_tmp->isValid()) {
                    ...
                    $collaborate_path = 'assets/images/whyarthbodh/' . $filename;
                    Image::make($image_tmp)->save($collaborate_path);
                }
            } else if (!empty($data['current_image'])) {
                $filename = $data['current_image'];
            ...
            Whyarthbodh::where('id',$id)->update(['title'=>$data['title'],'image'=>$filename]);
            return redirect('admin/view-whyarthbodh')->with('flash_message_success','New record updated successfully');
        }
        $whyarthbodh = Whyarthbodh::where('id',$id)->first();
        return view('admin.whyarthbodh.edit-whyarthbodh')->with(compact('whyarthbodh'));
    }

    public function viewWhyarthbodh(){
        $Whyarthbodh = Whyarthbodh::orderBy('id','ASC')->get();
        // dd($newsviewss);
        return view('admin.whyarthbodh.view-whyarthbodh')->with(compact('Whyarthbodh'));
    }

    public function deleteWhyarthbodh(Request $request, $id){
        Whyarthbodh::where('id',$id)->delete();
        return redirect()->back()->with('flash_message_success','Data deleted successfully');
    }
    ...
    public function addIndustry(Request $request){
        if($request->isMethod('post')){
            ...
            if($request->hasFile('pdf')) {
                ...
                $pdf = strtotime() . '.' . $file->getClientOriginalName();
            ...
            if($request->hasFile('image')) {
                ...
                if ($image_tmp->isValid()) {
                    $filename = strtotime("now").'-'. $image_tmp->getClientOriginalName();
                    $newsviews_path = 'assets/images/industry/'.$filename;
                    Image::make($image_tmp)->save($newsviews_path);
        ...
        if($request->isMethod('post')){
            ...
            if ($request->hasFile('image')) {
                ...
                if ($image_tmp->isValid()) {
                    ...
                    $collaborate_path = 'assets/images/industry/' . $filename;
                    Image::make($image_tmp)->save($collaborate_path);
                }
            } else if (!empty($data['current_image'])) {
                $filename = $data['current_image'];
