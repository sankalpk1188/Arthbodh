...
Route::get('/case-study-detail', [IndexController::class, 'caseStudyDetail']);

Route::get('/news-letter', [IndexController::class, 'newsletter']);
...
Route::match(['get','post'], '/info-required-for-mutualfund-kyc', [IndexController::class, 'mfKYC'])->name('mfKYC');
Route::match(['get','post'], '/doc-required-for-mutualfund-kyc', [IndexController::class, 'docKYC'])->name('docKYC');

Route::get('/blog', [IndexController::class, 'blogsListing']);
Route::get('/blog-detail', [IndexController::class, 'blogDetail']);
...
Route::get('/mutual-fund', [IndexController::class, 'mutual']);
Route::get('/equity-&-shares', [IndexController::class, 'equity']);
Route::get('/bonds-&-fixed-deposites', [IndexController::class, 'fixedDeposites']);
Route::get('/physical-shares-to-demat', [IndexController::class, 'physical']);
Route::get('/saturday-school', [IndexController::class, 'saturday']);
Route::get('/pms-distribution', [IndexController::class, 'pms']);
Route::get('/aif-distribution', [IndexController::class, 'aif']);
Route::get('/distribution-of-advisory-products', [IndexController::class, 'advisory']);
...
Route::middleware([AdminAuthenticated::class])->group(function () {
    ...
    // whyarthbodh
    Route::match(['get','post'], 'admin/add-whyarthbodh/', [HomepageController::class, 'addWhyarthbodh']);
    Route::match(['get','post'], 'admin/edit-whyarthbodh/{id}', [HomepageController::class, 'editWhyarthbodh']);
    Route::match(['get','post'], 'admin/view-whyarthbodh/', [HomepageController::class, 'viewWhyarthbodh']);
    Route::match(['get','post'], 'admin/delete-whyarthbodh/{id}', [HomepageController::class,'deleteWhyarthbodh']);
