...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs banner_ad">
        <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 pr-40 md-pr-15 md-mb-50">
                    ...
                    <h2 class="pt-3">Distribution of Advisory Products </h2>

                  

<ul class="list-marked">
    <li>We recognize that one size doesn't fit all.</li>
    <li> We will select strategies tailored to your unique financial situation and goals.</li>
    <li>With years of industry expertise, our team is
                        well-equipped to navigate the complexities of the financial landscape.</li>
                        <li>Your financial success is
                        our top priority.</li>
                        <li>Financial markets are dynamic, and we stay vigilant to make necessary
                        adjustments ensuring it remains aligned with your objectives.</li>
</ul>
