            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <form method="POST" action="{{ url('admin/add-banner') }}" enctype="multipart/form-data" id="addBanner">@csrf
                            <div class="card-body">
                                <div class="form-group col-md-10">  
                                    <label class="required">Image <small>(Size: 1350x500px)</small></label>
                                ...
                                <div class="form-group col-md-10">
                                    <div class="form-group col-md-10">
            	                        ...
            	                        <input name="title" id="title" class="form-control" placeholder="Enter Title" required>
            	                    </div>  
                              	</div>
