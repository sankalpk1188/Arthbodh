...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs banner_pms">
        <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 pr-40 md-pr-15 md-mb-50">
                    ...
                    <h2 class="pt-3">Customized PMS Solutions: Simplifying Your Investment Journey </h2>
                    ...
                    <ul class="list-marked">
                        <li>We are committed to providing seamless and efficient distribution solutions
                        for your Portfolio Management Services (PMS) needs in the Indian market.</li>
                        <li> We assist in selecting
                        the most suitable PMS products tailored to your investment goals, risk tolerance, and financial
                        preferences.</li>
                        <li>We can provide you with options to align the PMS with your specific requirements.</li>
                        <li>We conduct due diligence on PMS providers to ensure compliance, track record, performance, and
                        regulatory adherence.</li>
                        <li>Our team conducts thorough risk assessments to provide you with a clear
                        understanding of potential risks associated with different PMS strategies.</li>
                        <li> We monitor your
                        portfolio's performance on a regular basis and updates are sent to you with our inputs.</li>
                    </ul>
